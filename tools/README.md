...
- **`test_imdb_search_html.py` / `test_imdb_graphql_*.py` (legacy)** — Parser and JSON-shape checks against remote responses during integration work; superseded by fixture-driven offline runs in this export.
